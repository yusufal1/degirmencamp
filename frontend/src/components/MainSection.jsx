...
const MainSection = () => {
  return (
    <section className='flex flex-row justify-center my-[5%] items-center gap-10'>
        <div className=''>
            <img src={Img11} alt="sectionImage" width={400} className='img-clip'/>
        </div>
        <div className='flex flex-col gap-8 basis-1/4 '>
            ...
            <a href="#booking" className='mt-7 text-white px-6 py-4 rounded-3xl rez-btn w-1/2'>Daha Fazlasını Keşfet</a>
        </div>
    </section>
  )
}
