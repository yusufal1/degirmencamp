...
const Contact = () => {
  return (
    <div className='px-[20%] flex py-[10%]'>
        <div className='flex flex-row shadow-xl w-full border border-gray-200 rounded-lg'>
        ...
        <div className='flex flex-col basis-2/5 gap-5 p-[5%] bg-primary text-white'>
            ...
            <div className='flex gap-4 items-center'>
                ...
                <address>Değirmen kamp kazdağları, Zeytinli, 72. Sk. No:1, 10300 Edremit/Balıkesir</address>
            </div>
            <div className='flex gap-4 items-center'>
                <div className='p-4 bg-[#54bb8d] rounded-full'>
                    <FaPhone  size={25} color='white'/>
                </div>
                <span>+90 535 411 30 12</span>
            </div>
            <div className='flex gap-4 items-center'>
                <div className='p-4 bg-[#54bb8d] rounded-full'>
                    <IoMdMail  size={25} color='white'/>
                </div>
                <span>info@degirmencamp.com</span>
            </div>
        </div>
        </div>
    </div>
